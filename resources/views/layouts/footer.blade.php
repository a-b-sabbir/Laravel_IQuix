<footer>
    <div class="foot-wrapper clearfix">
        <a href="{{ url('/') }}">
            <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 719.34 170.85">
                <defs>
                    <style>
                        .cls-2 {
                            fill: #FFF;
        ...
        <div id="editor" class="floatleft">
            ...
            <div>
                আলহাজ্ব কোমর উদ্দিন খান সাহেব<br>
                সেলিমা শিরীণ খান<br>
                এ.এস.এম. জিয়া উদ্দিন খান<br>
                <br>
                <br>
                <br>
            </div>
        ...
        <div id="address" class="floatleft">
            <div>প্রধান কার্যালয়ঃ <br>
                ২৩৮, শিরীণ পয়েন্ট, মডেল স্কুল রোড, গোপালগঞ্জ - ৮১০০</div>
        </div>
    ...
    <div class="copyright clearfix">
        <div class="floatleft english">Copyright &copy; 2025 - Bhorer Bani</div>
        <div class="floatleft english">Webmaster - IQuix Ltd.</div>
    </div>
</footer>